...
func main() {
	...
	si, err := s.StageInstanceCreate(&dgo.StageInstanceParams{
		ChannelID:             *StageChannelID,
		Topic:                 "Amazing topic",
		PrivacyLevel:          dgo.StageInstancePrivacyLevelGuildOnly,
	...
	si, err = s.StageInstanceEdit(*StageChannelID, &dgo.StageInstanceParams{
